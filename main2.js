...
conn.sendBT(from, `*Passos para usa*\n\n*1.Criar grupo e dar adm ao bot*\n*2.Comando *menussh esperar bot te dar revenda*\n*3.Colocar seu vps comando *server seuvps senha*`, 
"",[
{index: 1, urlButton: {displayText: 'CONTATO TELEGRAM', url: 'https://t.me/batmonn'}},
{index: 2, urlButton: {displayText: 'CONTATO WHASTAPP', url: 'https://wa.me/+5511949356144'}}, 
{index: 3, urlButton: {displayText: 'COMO USAR O BOT', url:`https://youtu.be/prsGJ0SqH28`}}
], selo)
...
conn.sendBT(from, `*Passos para usa*\n\n*1.Criar grupo e dar adm ao bot*\n*2.Comando *menussh esperar bot te dar revenda*\n*3.Colocar seu vps comando *server seuvps senha*`, 
    "",[
    {index: 1, urlButton: {displayText: 'CONTATO TELEGRAM', url: 'https://t.me/batmonn'}},
    {index: 2, urlButton: {displayText: 'CONTATO WHATSAPP', url: 'https://wa.me/+5511949356144'}}, 
    {index: 3, urlButton: {displayText: 'COMO USAR O BOT', url:`https://youtu.be/prsGJ0SqH28`}}
    ], selo)
...
case "skyvps":
conn.sendMessage(from, {video:{url:'https://app.minerdso.com.br/videos/configbot.mp4'}, mimetype:'video/mp4'})
break
